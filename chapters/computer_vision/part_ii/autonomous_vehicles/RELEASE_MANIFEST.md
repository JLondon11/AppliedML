# 5. Computer Vision Part II — Canonical Release Manifest

## Canonical root
chapters/computer_vision/part_ii/autonomous_vehicles

## Required release organization
- manuscript/ — LaTeX source and build metadata
- figures/ — 56 accepted production figures organized by section
